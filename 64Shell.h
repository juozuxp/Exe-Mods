...
#define D_C_S(sn, ...) unsigned char INVALID1337##sn[] = { __VA_ARGS__ }; SHELL_RELATIVITY -= sizeof(INVALID1337##sn); static unsigned char sn[] = { __VA_ARGS__ } // Double contructs the shellcode to create valid checkpoints
...
#define R_MR_BO(r0, r1, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, (((r0) << 3) | (r1) | 0x40), BYTEPTR(bo)) // r0, [r1 + bo] [Size: 0x2]  [r1 - cannot be (rsp) (esp)]
#define R_MR_DO(r0, r1, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, (((r0) << 3) | (r1) | 0x80), DWORDPTR(do)) // r0, [r1 + do] [Size: 0x5]  [r1 - cannot be (rsp) (esp)]
#define R_LR(r0, r1) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, (((r0) << 3) | (r1) | 0xC0)) // r0, r1 [Size: 0x1]

#define R_REL_DO(r0, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, (((r0) << 3) | 0x5), DWORDPTR(do)) // r0, [rip + do] [Size: 0x5]
...
#define R_MRPR_BO(r0, r1, r2, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, (((r0) << 3) | 0x44), (((r2) << 3) | (r1)), BYTEPTR(bo)) // r0, [r1 + r2 + bo] [Size: 0x3] [r2 - cannot be (rsp) (esp)]
#define R_MRPR_DO(r0, r1, r2, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, (((r0) << 3) | 0x84), (((r2) << 3) | (r1)), DWORDPTR(do)) // r0, [r1 + r2 + do] [Size: 0x6] [r2 - cannot be (rsp) (esp)]
...
#define R_MRPR2_BO(r0, r1, r2, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, (((r0) << 3) | 0x44), (((r2) << 3) | (r1) | 0x40), BYTEPTR(bo)) // r0, [r1 + r2 * 2 + bo] [Size: 0x3] [r2 - cannot be (rsp) (esp)]
#define R_MRPR2_DO(r0, r1, r2, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, (((r0) << 3) | 0x84), (((r2) << 3) | (r1) | 0x40), DWORDPTR(do)) // r0, [r1 + r2 * 2 + do] [Size: 0x6] [r2 - cannot be (rsp) (esp)]
...
#define R_MRPR4_BO(r0, r1, r2, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, (((r0) << 3) | 0x44), (((r2) << 3) | (r1) | 0x80), BYTEPTR(bo)) // r0, [r1 + r2 * 4 + bo] [Size: 0x3] [r2 - cannot be (rsp) (esp)]
#define R_MRPR4_DO(r0, r1, r2, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, (((r0) << 3) | 0x84), (((r2) << 3) | (r1) | 0x80), DWORDPTR(do)) // r0, [r1 + r2 * 4 + do] [Size: 0x6] [r2 - cannot be (rsp) (esp)]
...
#define R_MRPR8_BO(r0, r1, r2, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, (((r0) << 3) | 0x44), (((r2) << 3) | (r1) | 0xC0), BYTEPTR(bo)) // r0, [r1 + r2 * 8 + bo] [Size: 0x3] [r2 - cannot be (rsp) (esp)]
#define R_MRPR8_DO(r0, r1, r2, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, (((r0) << 3) | 0x84), (((r2) << 3) | (r1) | 0xC0), DWORDPTR(do)) // r0, [r1 + r2 * 8 + do] [Size: 0x6] [r2 - cannot be (rsp) (esp)]

#define R_MRSP(r0) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, (((r0) << 3) | 0x4), 0x24) // r0, [rsp] [Size: 0x2]
#define R_MRSP_BO(r0, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, (((r0) << 3) | 0x44), 0x24, BYTEPTR(bo)) // r0, [rsp + bo] [Size: 0x3]
#define R_MRSP_DO(r0, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, (((r0) << 3) | 0x84), 0x24, DWORDPTR(do)) // r0, [rsp + do] [Size: 0x6]

#define R_M32(r0, m32) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, (((r0) << 3) | 0x4), 0x25, DWORDPTR(m32)) // r0, [m32] [Size: 0x6]
...
#define MR_BO(r0, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, ((r0) | 0x40), BYTEPTR(bo)) // [r0 + bo] [Size: 0x2] [r0 - cannot be (rsp) (esp)]
#define MR_DO(r0, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, ((r0) | 0x80), DWORDPTR(do)) // [r0 + do] [Size: 0x5] [r0 - cannot be (rsp) (esp)]
#define LR(r0) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, ((r0) | 0xC0)) // r0 [Size: 0x1] [r0 - cannot be (rsp) (esp)]

#define REL_DO(do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x5, DWORDPTR(do)) // [rip + do] [Size: 0x5]
...
#define MRPR_BO(r0, r1, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x44, (((r1) << 3) | (r0)), BYTEPTR(bo)) // [r0 + r1 + bo] [Size: 0x3] [r1 - cannot be (rsp) (esp)]
#define MRPR_DO(r0, r1, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, 0x84, (((r1) << 3) | (r0)), DWORDPTR(do)) // [r0 + r1 + do] [Size: 0x6] [r1 - cannot be (rsp) (esp)]
...
#define MRPR2_BO(r0, r1, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x44, (((r1) << 3) | (r0) | 0x40), BYTEPTR(bo)) // [r0 + r1 * 2 + bo] [Size: 0x3] [r1 - cannot be (rsp) (esp)]
#define MRPR2_DO(r0, r1, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, 0x84, (((r1) << 3) | (r0) | 0x40), DWORDPTR(do)) // [r0 + r1 * 2 + do] [Size: 0x6] [r1 - cannot be (rsp) (esp)]
...
#define MRPR4_BO(r0, r1, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x44, (((r1) << 3) | (r0) | 0x80), BYTEPTR(bo)) // [r0 + r1 * 4 + bo] [Size: 0x3] [r1 - cannot be (rsp) (esp)]
#define MRPR4_DO(r0, r1, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, 0x84, (((r1) << 3) | (r0) | 0x80), DWORDPTR(do)) // [r0 + r1 * 4 + do] [Size: 0x6] [r1 - cannot be (rsp) (esp)]
...
#define MRPR8_BO(r0, r1, bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x44, (((r1) << 3) | (r0) | 0xC0), BYTEPTR(bo)) // [r0 + r1 * 8 + bo] [Size: 0x3] [r1 - cannot be (rsp) (esp)]
#define MRPR8_DO(r0, r1, do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, 0x84, (((r1) << 3) | (r0) | 0xC0), DWORDPTR(do)) // [r0 + r1 * 8 + do] [Size: 0x6] [r1 - cannot be (rsp) (esp)]

#define MRSP INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x4, 0x24) // r0, [rsp] [Size: 0x2]
#define MRSP_BO(bo) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x44, 0x24, BYTEPTR(bo)) // r0, [rsp + bo] [Size: 0x3]
#define MRSP_DO(do) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, 0x84, 0x24, DWORDPTR(do)) // r0, [rsp + do] [Size: 0x6]

#define M32(m32) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x06, 0x4, 0x25, DWORDPTR(m32)) // [m32] [Size: 0x6]
...
#define ADDB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x04, BYTEPTR(b) // add al, b [Size: 0x2]
#define ADDW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x05, WORDPTR(w) // add al, w [Size: 0x4]
#define ADDD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x05, DWORDPTR(d) // add eax, d [Size: 0x5]
...
#define ORB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x0C, BYTEPTR(b)) // or al, b [Size: 0x2]
#define ORW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x0D, WORDPTR(w)) // or al, w [Size: 0x4]
#define ORD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x0D, DWORDPTR(d)) // or eax, d [Size: 0x5]
...
#define ADCB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x14, BYTEPTR(b)) // adc al, b [Size: 0x2]
#define ADCW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x15, WORDPTR(w)) // adc al, w [Size: 0x4]
#define ADCD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x15, DWORDPTR(d)) // adc eax, d [Size: 0x5]
...
#define SBBB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x1C, BYTEPTR(b)) // sbb al, b [Size: 0x2]
#define SBBW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x1D, WORDPTR(w)) // sbb al, w [Size: 0x4]
#define SBBD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x1D, DWORDPTR(d)) // sbb eax, d [Size: 0x5]
...
#define ANDB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x24, BYTEPTR(b)) // and al, b [Size: 0x2]
#define ANDW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x25, WORDPTR(w)) // and al, w [Size: 0x4]
#define ANDD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x25, DWORDPTR(d)) // and eax, d [Size: 0x5]
...
#define SUBB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x2C, BYTEPTR(b)) // sub al, b [Size: 0x2]
#define SUBW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x2D, WORDPTR(w)) // sub al, w [Size: 0x4]
#define SUBD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x2D, DWORDPTR(d)) // sub eax, d [Size: 0x5]
...
#define XORB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x34, BYTEPTR(b)) // xor al, b [Size: 0x2]
#define XORW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x35, WORDPTR(w)) // xor al, w [Size: 0x4]
#define XORD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x35, DWORDPTR(d)) // xor eax, d [Size: 0x5]

#define CMP_RM_R(rm_r) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x38, rm_r) // xor rm_r [Size: 0x1]
#define CMPD_RM_R(rm_r) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x39, rm_r) // xor rm_r [Size: 0x1]

#define CMP_R_RM(r_rm) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x3A, r_rm) // xor r_rm [Size: 0x1]
#define CMPD_R_RM(r_rm) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x3B, r_rm) // xor r_rm [Size: 0x1]

#define CMP_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x3C, BYTEPTR(b)) // xor al, b [Size: 0x2]
#define CMPW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x3D, WORDPTR(w)) // xor al, w [Size: 0x4]
#define CMPD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x3D, DWORDPTR(d)) // xor eax, d [Size: 0x5]
...
#define PUSH_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x68, WORDPTR(w)) // push w [Size: 0x4]
#define PUSH_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x68, DWORDPTR(d)) // push d [Size: 0x5]

#define IMUL_R_RM_W(r_rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x69, r_rm, WORDPTR(w)) // imul r_rm, w [Size: 0x3]
#define IMUL_R_RM_D(r_rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x69, r_rm, DWORDPTR(d)) // imul r_rm, d [Size: 0x5]

#define PUSH_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x6A, BYTEPTR(b)) // push b [Size: 0x2]

#define IMUL_R_RM_B(r_rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x6B, r_rm, BYTEPTR(b)) // imul r_rm, b [Size: 0x2]
...
#define JO_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x70, BYTEPTR(rb)) // jo rb [Size: 0x2]

#define JNO_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x71, BYTEPTR(rb)) // jo rb [Size: 0x2]

#define JB_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x72, BYTEPTR(rb)) // jb rb [Size: 0x2]
#define JNAE_RB(rb) JB_RB(rb) // jnae rb [Size: 0x2]
#define JC_RB(rb) JB_RB(rb) // jc rb [Size: 0x2]

#define JNB_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x73, BYTEPTR(rb)) // jnb rb [Size: 0x2]
#define JAE_RB(rb) JNB_RB(rb) // jae rb [Size: 0x2]
#define JNC_RB(rb) JNB_RB(rb) // jnc rb [Size: 0x2]

#define JZ_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x74, BYTEPTR(rb)) // jz rb [Size: 0x2]
#define JE_RB(rb) JZ_RB(rb) // je rb [Size: 0x2]

#define JNZ_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x75, BYTEPTR(rb)) // jnz rb [Size: 0x2]
#define JNE_RB(rb) JNZ_RB(rb) // jne rb [Size: 0x2]

#define JBE_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x76, BYTEPTR(rb)) // jbe rb [Size: 0x2]
#define JNA_RB(rb) JBE_RB(rb) // jna rb [Size: 0x2]

#define JNBE_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x77, BYTEPTR(rb)) // jnbe rb [Size: 0x2]
#define JA_RB(rb) JNBE_RB(rb) // ja rb [Size: 0x2]

#define JS_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x78, BYTEPTR(rb)) // js rb [Size: 0x2]

#define JNS_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x79, BYTEPTR(rb)) // jns rb [Size: 0x2]

#define JP_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x7A, BYTEPTR(rb)) // jp rb [Size: 0x2]
#define JPE_RB(rb) JP_RB(rb) // jpe rb [Size: 0x2]

#define JNP_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x7B, BYTEPTR(rb)) // jnp rb [Size: 0x2]
#define JPO_RB(rb) JNP_RB(rb) // jpo rb [Size: 0x2]

#define JL_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x7C, BYTEPTR(rb)) // jl rb [Size: 0x2]
#define JNGE_RB(rb) JL_RB(rb) // jnge rb [Size: 0x2]

#define JNL_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x7D, BYTEPTR(rb)) // jnl rb [Size: 0x2]
#define JGE_RB(rb) JNL_RB(rb) // jge rb [Size: 0x2]

#define JLE_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x7E, BYTEPTR(rb)) // jle rb [Size: 0x2]
#define JNG_RB(rb) JLE_RB(rb) // jng rb [Size: 0x2]

#define JNLE_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x7F, BYTEPTR(rb)) // jnle rb [Size: 0x2]
#define JG_RB(rb) JNLE_RB(rb) // jg rb [Size: 0x2]

#define ADD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, rm, BYTEPTR(b)) // add rm, b [Size: 0x2]
#define OR_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x8 | rm, BYTEPTR(b)) // or rm, b [Size: 0x2]
#define ADC_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x10 | rm, BYTEPTR(b)) // adc rm, b [Size: 0x2]
#define SBB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x18 | rm, BYTEPTR(b)) // sbb rm, b [Size: 0x2]
#define AND_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x20 | rm, BYTEPTR(b)) // and rm, b [Size: 0x2]
#define SUB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x28 | rm, BYTEPTR(b)) // sub rm, b [Size: 0x2]
#define XOR_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x30 | rm, BYTEPTR(b)) // xor rm, b [Size: 0x2]
#define CMP_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x80, 0x38 | rm, BYTEPTR(b)) // cmp rm, b [Size: 0x2]

#define ADD_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, rm, WORDPTR(w)) // add rm, w [Size: 0x4]
#define OR_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x8 | rm, WORDPTR(w)) // or rm, w [Size: 0x4]
#define ADC_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x10 | rm, WORDPTR(w)) // adc rm, w [Size: 0x4]
#define SBB_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x18 | rm, WORDPTR(w)) // sbb rm, w [Size: 0x4]
#define AND_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x20 | rm, WORDPTR(w)) // and rm, w [Size: 0x4]
#define SUB_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x28 | rm, WORDPTR(w)) // sub rm, w [Size: 0x4]
#define XOR_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x30 | rm, WORDPTR(w)) // xor rm, w [Size: 0x4]
#define CMP_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, 0x38 | rm, WORDPTR(w)) // cmp rm, w [Size: 0x4]

#define ADD_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, rm, DWORDPTR(d)) // add rm, d [Size: 0x5]
#define OR_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x8 | rm, DWORDPTR(d)) // or rm, d [Size: 0x5]
#define ADC_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x10 | rm, DWORDPTR(d)) // adc rm, d [Size: 0x5]
#define SBB_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x18 | rm, DWORDPTR(d)) // sbb rm, d [Size: 0x5]
#define AND_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x20 | rm, DWORDPTR(d)) // and rm, d [Size: 0x5]
#define SUB_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x28 | rm, DWORDPTR(d)) // sub rm, d [Size: 0x5]
#define XOR_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x30 | rm, DWORDPTR(d)) // xor rm, d [Size: 0x5]
#define CMP_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, 0x38 | rm, DWORDPTR(d)) // cmp rm, d [Size: 0x5]

#define ADDD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, rm, BYTEPTR(b)) // add rm, b [Size: 0x2]
#define ORD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x8 | rm, BYTEPTR(b)) // or rm, b [Size: 0x2]
#define ADCD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x10 | rm, BYTEPTR(b)) // adc rm, b [Size: 0x2]
#define SBBD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x18 | rm, BYTEPTR(b)) // sbb rm, b [Size: 0x2]
#define ANDD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x20 | rm, BYTEPTR(b)) // and rm, b [Size: 0x2]
#define SUBD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x28 | rm, BYTEPTR(b)) // sub rm, b [Size: 0x2]
#define XORD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x30 | rm, BYTEPTR(b)) // xor rm, b [Size: 0x2]
#define CMPD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0x83, 0x38 | rm, BYTEPTR(b)) // cmp rm, b [Size: 0x2]
...
#define MOV_AL_QM(qm) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x09, 0xA0, QWORDPTR(qm)) // mov al, [qm] [Size: 0x9]
#define MOV_EAX_QM(qm) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x09, 0xA1, QWORDPTR(qm)) // mov eax, [qm] [Size: 0x9]

#define MOV_QM_AL(qm) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x09, 0xA2, QWORDPTR(qm)) // mov [qm], al [Size: 0x9]
#define MOV_QM_EAX(qm) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x09, 0xA3, QWORDPTR(qm)) // mov [qm], eax [Size: 0x9]
...
#define TEST_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xA8, BYTEPTR(b)) // test al, b [Size: 0x2]
#define TEST_AX_D(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0xA9, WORDPTR(w)) // test ax, w [Size: 0x4]
#define TEST_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0xA9, DWORDPTR(d)) // test eax, d [Size: 0x5]
...
#define MOV_R_B(r, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, (0xB0 + (r)), BYTEPTR(b)) // mov r, b [Size: 0x2]
#define MOV_R_W(r, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, (0xB8 + (r)), WORDPTR(w)) // mov r, w [Size: 0x4]
#define MOV_R_D(r, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, (0xB8 + (r)), DWORDPTR(d)) // mov r, d [Size: 0x5]
#define MOV_R_Q(r, q) PFX_REXW, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x09, (0xB8 + (r)), QWORDPTR(q)) // mov r, q [Size: 0xA]
#define MOV_ER_Q(r, q) PFX_REXWB, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x09, (0xB8 + (r)), QWORDPTR(q)) // mov r, q [Size: 0xA]

#define ROLB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, rm, BYTEPTR(b)) // rol rm, b [Size: 0x2]
#define RORB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x8 | rm, BYTEPTR(b)) // ror rm, b [Size: 0x2]
#define RCLB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x10 | rm, BYTEPTR(b)) // rcl rm, b [Size: 0x2]
#define RCRB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x18 | rm, BYTEPTR(b)) // rcr rm, b [Size: 0x2]
#define SHLB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x20 | rm, BYTEPTR(b)) // shl rm, b [Size: 0x2]
#define SHRB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x28 | rm, BYTEPTR(b)) // shr rm, b [Size: 0x2]
#define SALB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x30 | rm, BYTEPTR(b)) // sal rm, b [Size: 0x2]
#define SARB_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC0, 0x38 | rm, BYTEPTR(b)) // sar rm, b [Size: 0x2]

#define ROLD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, rm, BYTEPTR(b)) // rol rm, b [Size: 0x2]
#define RORD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x8 | rm, BYTEPTR(b)) // ror rm, b [Size: 0x2]
#define RCLD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x10 | rm, BYTEPTR(b)) // rcl rm, b [Size: 0x2]
#define RCRD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x18 | rm, BYTEPTR(b)) // rcr rm, b [Size: 0x2]
#define SHLD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x20 | rm, BYTEPTR(b)) // shl rm, b [Size: 0x2]
#define SHRD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x28 | rm, BYTEPTR(b)) // shr rm, b [Size: 0x2]
#define SALD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x30 | rm, BYTEPTR(b)) // sal rm, b [Size: 0x2]
#define SARD_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC1, 0x38 | rm, BYTEPTR(b)) // sar rm, b [Size: 0x2]

#define RETN_W(w) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0xC2, WORDPTR(w)) // ret w [Size: 0x3]
#define RETN INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0xC3) // ret [Size: 0x1]

#define MOV_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xC6, rm, BYTEPTR(b)) // mov rm, b [Size: 0x2]
#define MOV_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0xC7, rm, WORDPTR(w)) // mov rm, w [Size: 0x4]
#define MOV_RM_D(rm, w) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0xC7, rm, DWORDPTR(w)) // mov rm, d [Size: 0x5]

#define ENTER(w, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x04, 0xC8, WORDPTR(w), BYTEPTR(b)) // enter w, b [Size: 0x4]
...
#define LOOPNZ_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE0, BYTEPTR(rb)) // loopnz rb [Size: 0x2]
#define LOOPNE_RB(rb) LOOPNZ_RB(rb) // loopne rb [Size: 0x2]

#define LOOPZ_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE1, BYTEPTR(rb)) // loopz rb [Size: 0x2]
#define LOOPE_RB(rb) LOOPNZ_RB(rb) // loope rb [Size: 0x2]

#define LOOP_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE2, BYTEPTR(rb)) // loop rb [Size: 0x2]

#define JECXZ_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE3, BYTEPTR(rb)) // jecxz rb [Size: 0x2]

#define IN_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE4, BYTEPTR(b)) // in al, b [Size: 0x2]
#define IN_EAX_D(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE5, BYTEPTR(b)) // in eax, b [Size: 0x2]

#define OUT_B_AL(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE6, BYTEPTR(b)) // out b, al [Size: 0x2]
#define OUT_D_EAX(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xE7, BYTEPTR(b)) // out b, eax [Size: 0x2]

#define CALL_RW(rw) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0xE8, WORDPTR(rw)) // call rw [Size: 0x4]
#define CALL_RD(rd) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0xE8, DWORDPTR(rd)) // call rd [Size: 0x5]

#define JMP_RW(rw) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0xE9, WORDPTR(rw)) // jmp rw [Size: 0x4]
#define JMP_RD(rd) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0xE9, DWORDPTR(rd)) // jmp rd [Size: 0x5]

#define JMP_RB(rb) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xEB, BYTEPTR(rb)) // jmp rb [Size: 0x2]
...
#define TEST_RM_B(rm, b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x02, 0xF6, rm, BYTEPTR(b)) // test rm, b [Size: 0x2]
...
#define TEST_RM_W(rm, w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0xF7, rm, WORDPTR(w)) // test rm, w [Size: 0x4]
#define TEST_RM_D(rm, d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0xF7, rm, DWORDPTR(d)) // test rm, d [Size: 0x5]
...
#define JO_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x80, WORDPTR(rw)) // jo rw [Size: 0x5]
#define JO_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x80, DWORDPTR(rd)) // jo rd [Size: 0x6]

#define JNO_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x81, WORDPTR(rw)) // jno rw [Size: 0x5]
#define JNO_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x81, DWORDPTR(rd)) // jno rd [Size: 0x6]

#define JB_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x82, WORDPTR(rw)) // jb rw [Size: 0x5]
#define JB_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x82, DWORDPTR(rd)) // jb rd [Size: 0x6]
...
#define JNB_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x83, WORDPTR(rw)) // jnb rw [Size: 0x5]
#define JNB_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x83, DWORDPTR(rd)) // jnb rd [Size: 0x6]
...
#define JZ_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x84, WORDPTR(rw)) // jz rw [Size: 0x5]
#define JZ_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x84, DWORDPTR(rd)) // jz rd [Size: 0x6]

#define JE_RW(rw) JZ_RW(rw) // je rw [Size: 0x5]
#define JE_RD(rd) JZ_RD(rd) // je rd [Size: 0x6]

#define JNZ_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x85, WORDPTR(rw)) // jnz rw [Size: 0x5]
#define JNZ_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x85, DWORDPTR(rd)) // jnz rd [Size: 0x6]
...
#define JBE_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x86, WORDPTR(rw)) // jbe rw [Size: 0x5]
#define JBE_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x86, DWORDPTR(rd)) // jbe rd [Size: 0x6]

#define JNA_RW(rw) JBE_RW(rw) // jna rw [Size: 0x5]
#define JNA_RD(rd) JBE_RD(rd) // jna rd [Size: 0x6]

#define JNBE_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x87, WORDPTR(rw)) // jnbe rw [Size: 0x5]
#define JNBE_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x87, DWORDPTR(rd)) // jnbe rd [Size: 0x6]

#define JA_RW(rw) JNBE_RW(rw) // ja rw [Size: 0x5]
#define JA_RD(rd) JNBE_RD(rd) // ja rd [Size: 0x6]

#define JS_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x88, WORDPTR(rw)) // js rw [Size: 0x5]
#define JS_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x88, DWORDPTR(rd)) // js rd [Size: 0x6]

#define JNS_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x89, WORDPTR(rw)) // jns rw [Size: 0x5]
#define JNS_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x89, DWORDPTR(rd)) // jns rd [Size: 0x6]

#define JP_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x8A, WORDPTR(rw)) // jp rw [Size: 0x5]
#define JP_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x8A, DWORDPTR(rd)) // jp rd [Size: 0x6]

#define JPE_RW(rw) JP_RW(rw) // jpe rw [Size: 0x5]
#define JPE_RD(rd) JP_RD(rd) // jpe rd [Size: 0x6]

#define JNP_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x8B, WORDPTR(rw)) // jnp rw [Size: 0x5]
#define JNP_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x8B, DWORDPTR(rd)) // jnp rd [Size: 0x6]

#define JPO_RW(rw) JNP_RW(rw) // jpo rw [Size: 0x5]
#define JPO_RD(rd) JNP_RD(rd) // jpo rd [Size: 0x6]

#define JL_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x8C, WORDPTR(rw)) // jl rw [Size: 0x5]
#define JL_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x8C, DWORDPTR(rd)) // jl rd [Size: 0x6]

#define JNGE_RW(rw) JL_RW(rw) // jnge rw [Size: 0x5]
#define JNGE_RD(rd) JL_RD(rd) // jnge rd [Size: 0x6]

#define JNL_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x8D, WORDPTR(rw)) // jnl rw [Size: 0x5]
#define JNL_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x8D, DWORDPTR(rd)) // jnl rd [Size: 0x6]

#define JGE_RW(rw) JNL_RW(rw) // jge rw [Size: 0x5]
#define JGE_RD(rd) JNL_RD(rd) // jge rd [Size: 0x6]

#define JLE_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x8E, WORDPTR(rw)) // jle rw [Size: 0x5]
#define JLE_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x8E, DWORDPTR(rd)) // jle rd [Size: 0x6]

#define JNG_RW(rw) JLE_RW(rw) // jng rw [Size: 0x5]
#define JNG_RD(rd) JLE_RD(rd) // jng rd [Size: 0x6]

#define JNLE_RW(rw) PFX_WORD, PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x03, 0x8F, WORDPTR(rw)) // jnle rw [Size: 0x5]
#define JNLE_RD(rd) PFX_0F, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x05, 0x8F, DWORDPTR(rd)) // jnle rd [Size: 0x6]
